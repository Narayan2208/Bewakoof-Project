function cardSlider (){
    ...
    <section>
      <div class="product">
        <img
          src="https://images.bewakoof.com/t320/women-white-freinds-life-m-printed-t-shirt-534623-1673585035-1.jpg"
          alt=""
        />
  <div style="padding-left: 10px;">
        <div class="detail">
          <div class="heading-div">
            <p>Bewakoof</p>
            <p class="font-size">Men's Black Super Loose Fit T-shirt</p>
          </div>
          <samp><i class="fa-regular fa-heart"></i></samp>
        </div>
        <div class="button" id="spacing">
          <h6>₹960</h6>
          <h6>₹1499</h6>
          <h6>39% OFF</h6>
        </div>
    ...
    <div class="button" id="spacing">
      ...
      <div class="product">
        <!-- <picture> -->
        <img
          src="https://images.bewakoof.com/t320/men-s-blue-customizable-half-sleeve-regular-fit-t-shirt-569066-1673855307-1.jpg"
          alt=""
        />
        <!-- </picture> -->
    <div style="padding-left: 10px;">
    ...
    <div class="button" id="spacing">
      ...
      <div class="product">
        <!-- <picture> -->
        <img
          src="https://images.bewakoof.com/t320/women-pink-oversized-printed-dress-554162-1671775633-1.jpg"
          alt=""
        />
        <!-- </picture> -->
        <div style="padding-left: 10px;">
    ...
    <div class="button" id="spacing">
      ...
      <div class="product">
        <!-- <picture> -->
        <img
          src="https://images.bewakoof.com/t320/women-s-purple-harry-s-house-graphic-printed-oversized-t-shirt-565913-1672383811-1.jpg"
          alt=""
        />
        <!-- </picture> -->
        <div style="padding-left: 10px;">
    ...
    <div class="button" id="spacing">
      ...
      <div class="product">
        <!-- <picture> -->
        <img
          src="https://images.bewakoof.com/t320/men-s-ginger-root-solid-oversized-fit-t-shirt-552870-1672295637-1.jpg"
          alt=""
        />
        <!-- </picture> -->
    <div style="padding-left: 10px;">
